...
def backtest_strategy(data):
    ...
    cerebro.run()
    return cerebro.broker.getvalue() / cerebro.broker.getcash() - 1
...
# انتخاب بهترین استراتژی (ترکیب همه)
